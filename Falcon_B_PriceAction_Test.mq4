...
//----------Entry & Exit Variables-----------
   ...
   PaResults results = PaProcessBars();
   ...
   CrossTriggered1=0; //Crossed1(FastMA1,SlowMA1);
   CrossTriggered2=0; //Crossed2(Ask,KeltnerUpper1);
   CrossTriggered3=0; //Crossed3(Bid,KeltnerLower1);
